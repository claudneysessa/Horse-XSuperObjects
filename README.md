...
This package is not my own, I just created middleware to facilitate the import and installation of the package in projects using BOSS.

All rights and credits are for:

[vkrapotkin](https://github.com/claudneysessa/x-superobject/commits?author=vkrapotkin)</br>
